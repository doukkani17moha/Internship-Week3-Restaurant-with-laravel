  ...
  <div class="container">
      <nav class="navbar navbar-expand-lg stroke px-0">
          <h1> <a class="navbar-brand" href="/">
              <img src="{{ asset('home/assets/images/burger.png') }}" alt="burger logo"width="35px" /> Burger Bun
              </a></h1>
...
<!-- Modal -->
<div class="modal fade" id="reservationSuccessModal" tabindex="-1" role="dialog" aria-labelledby="reservationSuccessModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Your reservation has been submitted successfully, we gonna contact you as soon as possible. Thank you!
            </div>
    ...
    <div class="row footer-top">
      ...
      <div class="col-lg-4 col-sm-6 footer-grid_section_1its mt-lg-0 mt-5">
        ...
        <ul class="list-unstyled payment-links mt-4">
          <li>
            <a href="#payment"><img src="{{ asset('home/assets/images/pay2.png') }}" class="radius-image" width="55px" alt=""></a>
          </li>
          <li>
            <a href="#payment"><img src="{{ asset('home/assets/images/pay5.png') }}" class="radius-image" width="55px" alt=""></a>
          </li>
          <li>
            <a href="#payment"><img src="{{ asset('home/assets/images/pay1.png') }}" class="radius-image" width="55px" alt=""></a>
          </li>
          <li>
            <a href="#payment"><img src="{{ asset('home/assets/images/pay4.png') }}" class="radius-image" width="55px" alt=""></a>
          </li>
        </ul>
      </div>
