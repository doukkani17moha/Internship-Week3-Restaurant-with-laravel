            ...
            <div class="row align-items-center py-lg-5 py-4 mt-4">
                <div class="col-lg-6 col-sm-12">
                    ...
                    <div class="mt-md-5 mt-4">
                        ...
                        <a class="btn btn-outline-primary btn-style" href="/reservation"> Book a table </a>
                    </div>
                </div>
                <div class="col-lg-5">
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6 left-wthree-img text-righ">
                        <div class="position-relative">
                            <img src="{{ 'home/assets/images/about.jpg' }}" alt=""
                            ...
                            <div id="small-dialog" class="zoom-anim-dialog mfp-hide">
                                <iframe src="https://www.youtube.com/embed/dCVEY88Fn1k" allow="autoplay; fullscreen"
                    ...
                    <div class="col-lg-6 mt-lg-0 mt-md-5 mt-4 about-right-faq align-self">
                        ...
                        <h3 class="title-big">Burgers! You won't Find Anywhere Else with Best Quality
        ...
        <div class="container py-lg-5 py-md-4 py-2">
            <div class="grids-area-hny main-cont-wthree-fea row">
                <div class="col-lg-4 col-md-6 grids-feature">
                    <div class="area-box">
                        <img src="{{ 'home/assets/images/burger.png' }}" alt="burger logo" width="35px">
                ...
                <div class="col-lg-4 col-md-6 grids-feature mt-md-0 mt-4">
                    <div class="area-box">
                        <img src="{{ 'home/assets/images/snack.png' }}" alt="burger logo" width="35px">
                ...
                <div class="col-lg-4 col-md-6 grids-feature mt-lg-0 mt-4">
                    <div class="area-box">
                        <img src="{{ 'home/assets/images/beverage.png' }}" alt="burger logo" width="35px">
            ...
            <div class="container">
                <div class="row mobile-info-inn mx-lg-0">
                    ...
                    <div class="col-lg-4 mobile-left">
                        <img src="{{ 'home/assets/images/burger1.png' }}" class="img-fluid radius-image" alt="">
                    </div>
                    <div class="col-lg-4 mobile-right">
                        <div class="row mobile-right-grids mb-lg-5 mb-4">
                            <div class="col-2 mobile-right-icon">
    ...
    <div class="middle py-5" id="call">
        <div class="container py-lg-3">
            <div class="welcome-left text-center py-md-5 py-3">
                ...
                <a href="/reservation" class="btn btn-style btn-outline-primary mt-sm-5 mt-4">Book a table</a>
            </div>
        </div>
    </div>
    <!-- //middle -->
            ...
            <div class="container py-lg-4 py-md-3">
                ...
                <div class="row no-gutters masonry">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <a href="{{ 'assets/images/'. $plat->plat_img }}" class="js-img-viwer d-block"
                            data-caption="The Right Ingredients for the Right Food." data-id="lion">
                            <img src="{{ 'assets/images/plats/'. $plat->plat_img }}" class="img-fluid radius-image-full"
                                alt="burger gallery" />
