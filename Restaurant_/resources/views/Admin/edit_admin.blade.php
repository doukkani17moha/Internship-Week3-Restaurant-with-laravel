                    ...
                    <form class="forms-sample" action="{{ asset('/admin-edit-process/'.$user->id) }}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="type" id="exampleSelectGender">
                          <option value="Super Admin" @php if($user->usertype=="Super Admin"){ echo"selected"; } @endphp>Super Admin</option>
                          <option value="Sub Admin"  @php if($user->usertype=="Sub Admin"){ echo"selected"; } @endphp>Sub Admin</option>
                        </select>
                      </div>
                      <div class="form-group">
